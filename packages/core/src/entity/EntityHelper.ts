...
export class EntityHelper {
  ...
  static decorate<T>(meta: EntityMetadata<T>, em: EntityManager): void {
   ...
   */
  private static defineBaseProperties<T>(meta: EntityMetadata<T>, prototype: T, em: EntityManager) {
  ...
  static defineReferenceProperty<T>(meta: EntityMetadata<T>, prop: EntityProperty<T>, ref: T): void {
  ...
  private static propagate<T, O>(meta: EntityMetadata<O>, entity: T, owner: O, prop: EntityProperty<O>, value?: O[keyof O]): void {
