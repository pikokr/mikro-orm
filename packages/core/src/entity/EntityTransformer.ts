...
export class EntityTransformer {
  ...
  static toObject<T>(entity: T, ignoreFields: string[] = [], raw = false): EntityData<T> {
  ...
  private static processProperty<T>(prop: keyof T & string, entity: T, raw: boolean): T[keyof T] | undefined {
    const wrapped = helper(entity);
  ...
  private static processEntity<T>(prop: keyof T, entity: T, platform: Platform, raw: boolean): T[keyof T] | undefined {
