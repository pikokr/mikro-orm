...
export class EntityAssigner {
  ...
  static assign<T>(entity: T, data: EntityData<T> | Partial<EntityDTO<T>>, options: AssignOptions = {}): T {
  ...
  private static assignReference<T>(entity: T, value: any, prop: EntityProperty, em: EntityManager, options: AssignOptions): void {
  ...
  private static assignCollection<T, U = AnyEntity>(entity: T, collection: Collection<U>, value: any[], prop: EntityProperty, em: EntityManager, options: AssignOptions): void {
    const invalid: any[] = [];
  ...
  private static assignEmbeddable<T>(entity: T, value: any, prop: EntityProperty, em: EntityManager | undefined, options: AssignOptions): void {
  ...
  private static createCollectionItem<T>(item: any, em: EntityManager, prop: EntityProperty, invalid: any[], options: AssignOptions): T {
