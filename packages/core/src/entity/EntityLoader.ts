...
export class EntityLoader {
   ...
   */
  async populate<T, P extends string = never>(entityName: string, entities: T[], populate: PopulateOptions<T>[] | boolean, options: EntityLoaderOptions<T, P>): Promise<void> {
   ...
   */
  private async populateMany<T>(entityName: string, entities: T[], populate: PopulateOptions<T>, options: Required<EntityLoaderOptions<T>>): Promise<AnyEntity[]> {
  ...
  private async findChildren<T>(entities: T[], prop: EntityProperty<T>, populate: PopulateOptions<T>, options: Required<EntityLoaderOptions<T>>): Promise<AnyEntity[]> {
  ...
  private async populateField<T>(entityName: string, entities: T[], populate: PopulateOptions<T>, options: Required<EntityLoaderOptions<T>>): Promise<void> {
  ...
  private getChildReferences<T>(entities: T[], prop: EntityProperty<T>, refresh: boolean): AnyEntity[] {
