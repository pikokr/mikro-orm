...
export type AnyEntity<T = any> = any;
...
export type GetRepository<T extends Record<symbol, any>, U> = T[typeof EntityRepositoryType] extends EntityRepository<T> | undefined ? NonNullable<T[typeof EntityRepositoryType]> : U;
...
export interface LoadedReference<T> extends Reference<AnyEntity & Defined<T>> {
  $: Defined<T>;
  get(): Defined<T>;
}
